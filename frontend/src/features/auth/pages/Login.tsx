...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(
        ...
        { email: email.trim(), motDePasse: motDePasse.trim(), rememberMe: remember },
      ...
      else setMessage(err?.message || "Erreur inattendue. Réessayez.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const loginWithGoogle = () => {
    // Option si tu veux propager la préférence: ?remember=true/false
      ...
      <div className="login-container">
        ...
        <div className="form-section">
          ...
          <form className="login-form" onSubmit={handleSubmit} noValidate>
            ...
            <label className="remember-row" style={{ display: "flex", gap: 8, alignItems: "center", marginTop: 8 }}>
              <input
                type="checkbox"
                checked={remember}
            ...
            <div className="divider-line"><span>Ou continuer avec</span></div>
          ...
          <div className="login-footer">
            <p>
              ...
              <Link to="/register" className="register-link">Inscris-toi</Link>
            </p>
          </div>
        </div>
      </div>
